...
import c30Image from '/src/assets/c30.png';
import "./../styles/prodcard.css";function ProductCard({ name, category, description, price, oldPrice, discount, image, reviews, rating }) {
  return (
    <div className="product-card">
      <div className="product-image">
        <img src={c30Image} alt={name} />
